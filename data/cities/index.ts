...
const SEEDS: readonly CitySeed[] = [
  ...
  { id: 'pekanbaru', name: 'Pekanbaru', province: 'Riau', lat: 0.5071, lon: 101.4478, coastal: false, fireBelt: true, note: { id: 'Lahan gambut Riau — salah satu simpangan musim kebakaran terkuat dalam rangkaian ini.', en: 'Riau peatland — among the strongest fire-season divergence in the series.' } },
  ...
  { id: 'batam', name: 'Batam', province: 'Kepulauan Riau', lat: 1.0456, lon: 104.0305, coastal: true, fireBelt: false, note: { id: 'Alur pelayaran padat; cahaya di lepas pantai adalah bagian besar dari jendela ini.', en: 'Dense shipping lanes; offshore light is a large part of this window.' } },
  ...
  { id: 'palangkaraya', name: 'Palangka Raya', province: 'Kalimantan Tengah', lat: -2.21, lon: 113.92, coastal: false, fireBelt: true, note: { id: 'Gambut dalam. Awan monsun dan asap kebakaran sama-sama memangkas liputan bebas awan di sini.', en: 'Deep peat. Monsoon cloud and fire smoke both cut cloud-free coverage here.' } },
  ...
  { id: 'ikn', name: 'IKN Nusantara', province: 'Kalimantan Timur', lat: -0.98, lon: 116.68, coastal: true, fireBelt: true, note: { id: 'Kawasan Sepaku. Bandingkan dengan Balikpapan dan Samarinda, jangan dibaca sendirian.', en: 'Sepaku area. Compare against Balikpapan and Samarinda rather than reading alone.' } },
  ...
  { id: 'makassar', name: 'Makassar', province: 'Sulawesi Selatan', lat: -5.1477, lon: 119.4327, coastal: true, fireBelt: false, note: { id: 'Salah satu wilayah penangkapan ikan berlampu terpadat di nusantara berada di lepas pantainya.', en: 'One of the densest light-fishing grounds in the archipelago lies offshore.' } },
  ...
  { id: 'wamena', name: 'Wamena', province: 'Papua Pegunungan', lat: -4.0996, lon: 138.952, coastal: false, fireBelt: false, note: { id: 'Lembah pegunungan. Awan orografis yang terus-menerus membuat liputannya paling tipis dalam daftar ini.', en: 'Highland valley. Persistent orographic cloud makes this the thinnest coverage in the list.' } },
