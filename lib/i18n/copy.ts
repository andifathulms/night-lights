...
const ID: Copy = {
  ...
  change: {
    ...
    toYear: 'Ke tahun',
    columnCity: 'Kota',
    columnLitChange: 'Δ bagian bercahaya (poin persen)',
    columnRadianceChange: 'Δ radians rata-rata (nW/cm²/sr)',
...
const EN: Copy = {
  ...
  change: {
    ...
    toYear: 'To year',
    columnCity: 'City',
    columnLitChange: 'Δ lit share (percentage points)',
    columnRadianceChange: 'Δ mean radiance (nW/cm²/sr)',
